export const sendQueryToBot = async (query, lang, setMessages, setLoading, typingDots) => {
    setLoading(true);
    setMessages((prev) => [...prev, { text: "Typing" + typingDots, sender: "bot" }]);
    ...
    try {
      ...
      setMessages((prev) => {
        const updatedMessages = prev.slice(0, -1); // Remove "Typing..."
        return [
          ...updatedMessages,
          {
