    ...
    <>
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: "70px" }}>
          <img src={iconUrl} alt="Weather Condition" style={{ width: "60px", height: "60px" }} />
          ...
          <Grid item xs={6}>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Box>
                ...
                <Typography variant="h6" fontWeight="500" fontSize={"20px"}>{humidity}%</Typography>
              </Box>
            </Box>
          </Grid>
          <Grid item xs={6}>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Box>
                ...
                <Typography variant="h6" fontWeight="500" fontSize={"20px"}>{wholeWindSpeed} km/h</Typography>
              </Box>
            </Box>
          </Grid>
        </Grid>
